...
startWizard.on('callback_query', async (ctx) => {
    try {
        ...
        await ctx.reply(`${ sum>500? 'Выберите способ доставки': `Выберите способ доставки.\nВнимание! Доставим бесплатно, если наберете товаров еще на ${500-sum}₽`}`, Markup.keyboard([
            ['🚗Доставка', '🙋‍♂️Самовывоз'],
            ['Выйти в меню']
        ]).resize())
